...
/**
 * 
 * This class is the main class from which all the other classes are used,by creating objects of them,and using
 * their operation.In this class there is the main method of the program 
 * {@linkplain civilization_Game_Version1.CivilizationGame#main(String[])}.This class is responsible for the interface of the 
 * game.It asks for the player to do his/her actions by giving a corresponding input to the program.Also this class
 * uses exceptions and other techniques for better operation of the game.
 * 
 * 
