 ...
 * moment).This class contains:
 * Instance variables: 
 * {@linkplain civilization_Game_Version1.River#fishOfRiver}
 * {@linkplain civilization_Game_Version1.River#name}
 * Two static constants:
 * {@linkplain civilization_Game_Version1.River#NUM_OF_ACCEPTABLE_FISH}  
 * One Constructor:
 * {@linkplain civilization_Game_Version1.River#River(String)}
 * One Copy constructor:
 * {@linkplain civilization_Game_Version1.River#River(River)}
 * And instance methods:
 * {@linkplain civilization_Game_Version1.River#getFish()}
 * {@linkplain civilization_Game_Version1.River#getName()}
 * {@linkplain civilization_Game_Version1.River#replenishFish()}
 * {@linkplain homework2.River#}
 * 
 * 
 * 
...
public class River {
	 ...
	 * ,to a new object type of River.Creates a new array for the attribute  {@linkplain civilization_Game_Version1.River#fishOfRiver}
	 * and assigns to the new array all the fields of the old array(to the corresponding position).Also copies the 
	 * String name of the old River to the new River
	 * 
	...
	/**
	 * A constructor which creates an object type of River by creating a new array type of {@linkplain civilization_Game_Version1.Fish}
	 * and fills each position of the array with Fish objects which have random health points(each one). Also gives
	 * the name to the River as it was sent as a String (as a parameter).
	 * 
	 * @author valentinos Pariza 
	 * @since 21/8/2018
	...
	/**
	 * A method which checks if there are any fish in the array of fish {@linkplain civilization_Game_Version1.River#fishOfRiver}.
	 * 
	 * @author valentinos Pariza 
	 * @since 21/8/2018
	...
	/**
	 * This method after checks that there are fish in the array of {@linkplain civilization_Game_Version1.River#fishOfRiver},sends
	 * the next fish object which is available.
	 * 
	 * @author valentinos Pariza 
	 * @since 21/8/2018
	 * @return an object Fish{@linkplain civilization_Game_Version1.Fish}, which represents the next amount of fish that can be fished
	 */
	public Fish getFish() {
	...
	/**
	 *This method is used in order to refill the array of object Fish {@linkplain civilization_Game_Version1.River#fishOfRiver} when is
	 *called by checking first that there aren't any object Fish in the array.If refills the array sends true 
	 *otherwise false. 
	 * 
	 * @author valentinos Pariza 
	 * @since 21/8/2018
	 * @return true if the array of Fish {@linkplain civilization_Game_Version1.River#fishOfRiver} was refilled or false otherwise.
	 */
