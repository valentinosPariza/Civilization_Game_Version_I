 ...
 * Instance variables: 
 * {@linkplain civilization_Game_Version1.Settlement#buildings}
 * {@linkplain civilization_Game_Version1.Settlement#name}
 * A static constant attribute:
 * {@linkplain civilization_Game_Version1.Settlement#INITIAL_NUM_OF_BUILDINGS}
 * 
 * One Copy Constructor Constructors:
 *{@linkplain civilization_Game_Version1.Settlement#Settlement(Settlement)}
 * One Constructor:
 * {@linkplain civilization_Game_Version1.Settlement#Settlement(String)}
 * These instance methods:
 * {@linkplain civilization_Game_Version1.Settlement#addBuilding(Building)}
 * {@linkplain civilization_Game_Version1.Settlement#build(int, Population, int, int)}
 * {@linkplain civilization_Game_Version1.Settlement#getName()}
 * {@linkplain civilization_Game_Version1.Settlement#isFull()}
 * {@linkplain civilization_Game_Version1.Settlement#expandSettlement()}
 * {@linkplain homework2.Settlement#}
 * 
 * 
 * 
...
public class Settlement {
	...
	public void addBuilding(Building newbuilding) {
		...
		for (int i = 0; i < buildings.length; i++) {
			if (buildings[i] == null) {					// finds the position which doesn't have any object
				buildings[i] = newbuilding;				// and put the new object -Building in there
				if (this.isFull())
					this.expandSettlement();			// after this,if the array is full,then the program expands it
				break;
			}
		}
	}
