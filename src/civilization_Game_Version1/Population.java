 ...
 * This class contains
 * Instance variables: 
 * {@linkplain civilization_Game_Version1.Population#civilans}
 * {@linkplain civilization_Game_Version1.Population#happiness}
 * {@linkplain civilization_Game_Version1.Population#rand}
 * {@linkplain civilization_Game_Version1.Population#warriors}
 * A static contant attribute of the class:
 * {@linkplain civilization_Game_Version1.Population#TIMES_COAL_BURNS_FOR_PRODUCTION}
 * One Constructor:
 * {@linkplain civilization_Game_Version1.Population#Population()}
 * Instance Methods
 * {@linkplain civilization_Game_Version1.Population#canBattle()}
 * {@linkplain civilization_Game_Version1.Population#canCook(Fish, CoalMine)}
 * {@linkplain civilization_Game_Version1.Population#canCook(Game, CoalMine)}
 * {@linkplain civilization_Game_Version1.Population#canwork(int)}
 * {@linkplain civilization_Game_Version1.Population#decreaseHappiness(int)}
 * {@linkplain civilization_Game_Version1.Population#fish(River)}
 * {@linkplain civilization_Game_Version1.Population#getCivilians()}
 * {@linkplain civilization_Game_Version1.Population#getHappiness()}
 * {@linkplain civilization_Game_Version1.Population#getWarriors()}
 * {@linkplain civilization_Game_Version1.Population#hunt(Hills)}
 * {@linkplain civilization_Game_Version1.Population#increase_population()}
 * {@linkplain civilization_Game_Version1.Population#increaseHappiness(int)}
 * {@linkplain civilization_Game_Version1.Population#setWarriors(int)}
 * 
 * 
 * 
...
public class Population {
	 ...
	 * method {@linkplain civilization_Game_Version1.Hills#hunt()} in order to simulate the action of hunt and return the food gained
	 ...
	 * This method uses method {@linkplain civilization_Game_Version1.Population#increase_population()} for increasing population.
	 * 
	 * @author valentinos Pariza 
	 * @since 21/8/2018
